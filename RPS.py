...
class RpsGame():
    def __init__(self):
        ...
        self.bg = pygame.image.load("https://drive.google.com/file/d/19INUlO-2-oLCRBd7qZETwsl-xoftg8Kg/view?usp=drive_link")
        self.r_btn = pygame.image.load("https://drive.google.com/file/d/1seSv9ZXh-qqBVfnLUeGSVXTUv5uMDl2l/view?usp=drive_link").convert_alpha()
        self.p_btn = pygame.image.load("https://drive.google.com/file/d/1wztmwuUQU4usn2spzgQkNCO2eLUTTCPO/view?usp=drive_link").convert_alpha()
        self.s_btn = pygame.image.load("https://drive.google.com/file/d/1J5-qbCat0xHE_oGK8jQkGDEjfXaxsME4/view?usp=drive_link"

).convert_alpha()

        self.choose_rock = pygame.image.load("https://drive.google.com/file/d/1b2LFXkiWxlJapbnwfs0Z4nPbAhUkEj4f/view?usp=drive_link").convert_alpha()
        self.choose_paper = pygame.image.load("https://drive.google.com/file/d/1dxch4ftjFDELekVXpeB9cpWcHw4JFBx4/view?usp=drive_link").convert_alpha()
        self.choose_scissors = pygame.image.load( "https://drive.google.com/file/d/1ByuN1uYU6bNqQCjmXCVLZgSYp9VCGcVJ/view?"
